...
parser.add_argument('--first_training_iters', type=int, default=400000)
parser.add_argument('--second_training_iters', type=int, default=100000)
...
training_iters = args.first_training_iters
train_psnr_max = 0.0
...
ssim_values = []
for i in range(min(max_test_num, len(data['test']['images']))):
...
training_iters = args.second_training_iters
